...
% TODO: maybe time an expert user?
% TODO: this should go in results section
...
\begin{enumerate}[noitemsep]
    \item Insert press-in components into the feeder base. This includes M3 nut (2x), M3 standoff (2x), and 3/16" diameter dowel pin (2x). This
        requires a mallet.
    ...
    \item Cut two 5 cm sections from the M3 threaded rod. Turn each section
        into the M3 nut which behind the feeder base.
    ...
    \item Thread a torsional spring onto the dowel pin. Squeeze between the
        shallow
\end{enumerate}}
...
\item Stick two \textit{additional} magnets to those you just inserted into spring rotor
and then use the spring rotor to press fit these two magnets into the spring
rotor base. This procedure ensures that magnets will pub pushed into the spring rotor base with the correct polarity.
