...
%   - Make sure the rat and mouse CA1 recordings are addressed in the text
%   somewhere
%
...
%   2. No wire folding! just draw wire it from pre-loaded bobbins.
%   3. Auto-aligning, magnetic wire bundle retention mechanism results in perfectly straight probes every time.
%   4. 3D-printed leaf spring provides constant wire tension during high speed twist
%   5. Turn as fast as you want. We use 1000 RPM. Your tetrode is done in seconds :).
%   6. Put a tick on the sheet (link) if you want one. We are gauging interest for distribution on the Open Ephys store (link). Of course, the bill of materials construction steps are included in the manuscirpt if you just want to make your own!
