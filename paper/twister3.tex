...
%
% - Tweet:
%   1. Here is my work with @jvoigts, @OpenEphys, and @SpikeGadgets on an open source, cheap, and fast tetrode making machine (link). We have been using it in the Wilson and Harnett labs for the past 2 years. It allows you to make probes quickly and reliably. Some features: (1/N)
...
\begin{enumerate}[noitemsep]
    ...
    \item Attach two \textit{additional} magnets on top of those you just inserted into
        alignment plate. Press the spring rotor onto these magnets to press fit them
        into the spring rotor base. This procedure ensures that magnets
        will be press fit into the spring rotor base with the correct polarity.
        Make sure the magnets are below the bottom surface of the spring rotor
        so that it rests flat on top of the alignment plate.
...
\begin{enumerate}[noitemsep]
    ...
    \item With the wire-clip mechanimsm installed, slide the adjustment plate
        ...
        the wire buldle will appear motionless during motor turning.
\end{enumerate}
}
